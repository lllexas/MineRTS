...
namespace MineRTS.BigMap.UI.Panels
{
    ...
    /// 智能体根面板动画器
    ///
    /// <para>【UI ID】AgentRootPanel - 用于事件匹配</para>
    /// <para>【职责】智能体系统根面板（AI 代理、助手设置等）</para>
    /// </summary>
    public class AgentRootPanelAnimator : SpaceUIAnimator
    {
        /// <summary>
        /// UI ID - 由代码硬编码，Inspector 显示但不可改
        /// </summary>
        protected override string UIID => "AgentRootPanel";
        ...
        {
            // 点击智能体根面板，打开智能体主面板
            PostSystem.Instance.Send("期望显示面板", "AgentPanel");
            Debug.Log("<color=cyan>[AgentRootPanel]</color> 点击打开 AgentPanel");
        }
    }
}
