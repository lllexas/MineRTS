...
public class SignalContext
{
    ...
    public SignalContext(string currentNodeId = null, object args = null, List<ConnectionData> traveledPath = null)
    {
    ...
    public SignalContext Clone(bool copyPath = false)
    {
        var newPath = copyPath && TraveledPath != null 
            ...
            : TraveledPath;
        return new SignalContext(CurrentNodeId, Args, newPath);
    }
