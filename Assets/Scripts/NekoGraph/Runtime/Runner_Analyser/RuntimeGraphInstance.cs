...
public class RuntimeGraphInstance
{
    ...
    /// <summary>
    /// 源 JSON 文件名（记录从哪个 Pack 加载的，用于读档）
    ...
    public RuntimeGraphInstance(string instanceID, string graphType = "Generic", string sourceJsonFileName = null)
    {
