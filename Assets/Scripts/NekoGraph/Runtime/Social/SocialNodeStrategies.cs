...
/// </summary>
public class SocialMsgContentNodeStrategy : INodeStrategy
{
    public void OnSignalEnter(BaseNodeData data, SignalContext context, RuntimeGraphInstance instance)
    {
        ...
        // 2. 信号直接穿透，不阻塞喵~
        Propagate(contentNode, context, instance);
    }

    public void OnEvent(BaseNodeData data, string eventName, object eventData, RuntimeGraphInstance instance) { }

    private void Propagate(SocialMsgContentNodeData node, SignalContext context, RuntimeGraphInstance instance)
    {
...
/// </summary>
public class ChoiceTextNodeStrategy : INodeStrategy
{
    public void OnSignalEnter(BaseNodeData data, SignalContext context, RuntimeGraphInstance instance)
    {
        ...
        // 2. 信号穿透喵~
        Propagate(choiceNode, context, instance);
    }

    public void OnEvent(BaseNodeData data, string eventName, object eventData, RuntimeGraphInstance instance) { }

    private void Propagate(ChoiceTextNodeData node, SignalContext context, RuntimeGraphInstance instance)
    {
        foreach (var conn in node.OutputConnections)
        {
            var newSignal = context.Clone();
...
/// 社交终结节点策略 - 宣告对话圆满结束喵~
/// </summary>
public class SocialMsgEndNodeStrategy : INodeStrategy
{
    public void OnSignalEnter(BaseNodeData data, SignalContext context, RuntimeGraphInstance instance)
    {
        // 广播结束事件
        PostSystem.Instance.Send("Social.MsgFinished", instance.InstanceID);
